        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    ...
                    <form class="form-horizontal m-t-20" id="loginform" action="{{route('password.resetpassword.post')}}" method="POST">
                        @if (Session::get('fail'))
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <button class="btn btn-success btn-lg btn-block" type="submit">Submit</button><br>
                                    </div>
                                </div>
                            </div>
                        </div>
          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small" style="color: #07187B">Enter your email and new password</p>
                  </div>
              ...
              @endif
                  ...
                  <form class="row g-3 needs-validation" id="loginform" action="{{route('password.resetpassword.post')}}" method="POST" novalidate>
